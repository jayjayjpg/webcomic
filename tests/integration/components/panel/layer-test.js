...
module('Integration | Component | panel/layer', function(hooks) {
  ...
  test('it renders', async function(assert) {
    ...
    assert.dom('[data-test-panel-layer]').hasAttribute('src', 'https://somerandomimmmage.io/url.jpg');
    assert.dom('[data-test-panel-layer]').hasAttribute('alt', 'Random description');
  });
});
